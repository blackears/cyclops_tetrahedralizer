...
static double narrowdoublerand(void)
{
    double result;
    double expo;
    long a, b, c;
...
static double uniformdoublerand(void)
{
    double result;
    long a, b;
...
static float narrowfloatrand(void)
{
    float result;
    float expo;
    long a, c;
...
static float uniformfloatrand(void)
{
    float result;
    long a;
